...
func (t *SimpleChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
	...
	if function == "queryHis" {
		// queries an entity state
		return t.queryHis(stub, args)
	}
...
// queryHis queryHis
func (t *SimpleChaincode) queryHis(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	fmt.Printf("- getHistoryForA returning:\n%s\n", buffer.String())
